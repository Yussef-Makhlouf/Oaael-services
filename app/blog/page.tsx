...
export const metadata: Metadata = {
  title: 'المدونة | شركة العالمية للعوازل',
  description: 'اكتشف أحدث المقالات والنصائح الاحترافية حول عزل الفوم وعزل الأسطح في الرياض والخرج مع شركة العالمية للعوازل.',
  keywords: [
    'نصائح عزل الفوم', 'مشاكل عزل الاسطح', 'طريقة عزل الفوم', 'افضل مواد العزل',
    'مدونة العزل', 'حلول ارتفاع فاتورة الكهرباء', 'اشكال عزل الفوم'
  ],
  openGraph: {
    title: 'المدونة | شركة العالمية للعوازل',
    description: 'اكتشف أحدث المقالات والنصائح الاحترافية حول عزل الفوم وعزل الأسطح في الرياض والخرج مع شركة العالمية للعوازل.',
